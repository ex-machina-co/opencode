...
async function showRemovalSummary(targets: RemovalTargets, method: Installation.Method) {
  ...
  if (method !== "curl" && method !== "unknown") {
    const cmds: Record<string, string> = {
      npm: "npm uninstall -g @ex-machina/opencode",
      pnpm: "pnpm uninstall -g @ex-machina/opencode",
      bun: "bun remove -g @ex-machina/opencode",
      yarn: "yarn global remove @ex-machina/opencode",
